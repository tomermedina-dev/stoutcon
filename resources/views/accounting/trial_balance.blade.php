...
@section('content_header')
  <div class="row mb-2">
    <div class="col-sm-6">
      <h1>TRIAL BALANCE {{ $month_year }}</h1>
    </div>
    <div class="col-sm-6">
      <ol class="breadcrumb float-sm-right">
       <li class="breadcrumb-item"><a href="{{ route('admin.trial.balance') }}">Period</a></li>
  ...
  <div class="row">
    ...
    <div class="col-12">
      <div class="callout callout-info h-100">
        &nbsp;
        <button type="button" class="btn btn-success float-right" name="tial_balance" id="add" data-action="{{ route('admin.trial.balance.store') }}">
          <i class="fas fa-plus"></i> Add Trial Blance Data
        </button>
         &nbsp;
    ...
    <div class="col-md-12">
           ...
           <div class="card card-secondary callout-info h-100">
            <div class="card-header">
               ...
               <h3 class="card-title">&nbsp;</h3>
                 ...
                 <div class="card-footer">
                    ...
                    &nbsp;
                    <a type="button" class="btn btn-primary float-right" name="tial_balance"  href="{{ route('admin.pdf.trial',[ 'month' => $month, 'year' => $year] ) }}" target="_blank">
            ...
            <div class="modal-body">
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-xs-12 form-group {{ $errors->has('tool') ? 'has-error' : '' }}">
                        {!! Form::label('tool','Tool', ['class' => 'control-label']) !!} 
                        {!!Form::select('tool', array('1' => 'Debit', '2' => 'Credit'), '0', ['autocomplete' => 'off','class' => 'form-control', 'placeholder' => '']); !!}
                        <em class="invalid-feedback" id="tool-error">
                        </em>
                    </div>
                    ...
                    <div class="col-xs-12 form-group {{ $errors->has('type') ? 'has-error' : '' }}">
                        ...
                        {!!Form::select('type', array('1' => 'Assets', '2' => 'Liabilities','3' => 'Equity','4' => 'Revenue or Income', '5' => 'Expenses'), '0', ['autocomplete' => 'off','class' => 'form-control', 'placeholder' => '']); !!}
                        <em class="invalid-feedback" id="type-error">
                        </em>
                    </div>
                    

                    <div class="col-xs-12 form-group {{ $errors->has('category') ? 'has-error' : '' }}">
                        {!! Form::label('category','Category', ['class' => 'control-label']) !!} 
                        {!!Form::select('category', array('1' => 'Current', '2' => 'Fixed'), '0', ['autocomplete' => 'off','class' => 'form-control', 'placeholder' => '']); !!}
                        <em class="invalid-feedback" id="category-error">
                        </em>
                    </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    table =  $('#table-accounts').DataTable({
        ...
        scrollCollapse:true,
         ajax:{
            url: "{{ route('admin.trial.balance.view',[$month,$year]) }}",
         },
         columns:[
