  ...
  <div class="row">
    ...
    <div class="col-12">
      <div class="callout callout-info h-100">
        &nbsp;
        <button type="button" class="btn btn-success float-right" name="period" id="add" data-action="{{ route('admin.trial.balance.period.store') }}">
            ...
            <div class="card-header">
              <h3 class="card-title">&nbsp;</h3>
                 ...
                 <div class="card-body table-responsive">
                   ...
                   <table id="table-trial-balance" class="table table-bordered table-striped compact" width="100%"> 
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    table = $('#table-trial-balance').DataTable({
        ordering: true,
        iDisplayLength: 100,
        bPaginate: true,
        bLengthChange: true,
