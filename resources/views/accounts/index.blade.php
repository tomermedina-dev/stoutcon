              ...
              <div class="row">
                <div class="col-md-6">
                   ...
                   <div class="col-xs-12 form-group {{ $errors->has('status') ? 'has-error' : '' }}">
                        ...
                        {!!Form::select('status', array('0' => 'Resigned','1' => 'Active','2' => 'End of Contract','3' => 'Terminated'), '1', ['autocomplete' => 'off','class' => 'form-control', 'placeholder' => '']); !!}
...
<script type="text/javascript">
  ...
  $('#salary_amount').on('keyup',function(){
   ...
   // SSS = basic * 0.0336 
    ...
    // sss_contribution = basic_salary / 499.99;//basic_salary * 0.0336;
    // sss_contribution = (sss_contribution * 20) + 80;
    ...
    var x = basic_salary;
    switch (x) {
            case checkRange(x, 0, 2499.99 ):
              $('#sss_contribution').val(80.00);
              break;

            case checkRange(x, 2250, 2749.99 ):
              $('#sss_contribution').val(100.00);
              break;
            case checkRange(x, 2750, 3249.99):
              $('#sss_contribution').val(120.00);
              break;
            case checkRange(x, 3250, 3749.99):
            $('#sss_contribution').val(140.00);
              break;
            case checkRange(x, 3750, 4249.99):
            $('#sss_contribution').val(160.00);
              break;
            case checkRange(x, 4250, 4749.99):
            $('#sss_contribution').val(180.00);
              break;
            case checkRange(x, 4750, 5249.99):
            $('#sss_contribution').val(200.00);
              break;
            case checkRange(x, 5250, 5749.99):
            $('#sss_contribution').val(220.00);
              break;
            case checkRange(x, 5750, 6249.99):
            $('#sss_contribution').val(240.00);
              break;
            case checkRange(x, 6250, 6749.99):
            $('#sss_contribution').val(260.00);
              break;
            case checkRange(x, 6750, 7249.99):
            $('#sss_contribution').val(280.00);
              break;
            case checkRange(x, 7250, 7749.99):
            $('#sss_contribution').val(300.00);
              break;
            case checkRange(x, 7750, 8249.99):
            $('#sss_contribution').val(320.00);
              break;
            case checkRange(x, 8250, 8749.99):
            $('#sss_contribution').val(340.00);
              break;
            case checkRange(x, 8750, 9249.99):
            $('#sss_contribution').val(360.00);
              break;
            case checkRange(x, 9250, 9749.99):
            $('#sss_contribution').val(380.00);
              break;
            case checkRange(x, 9750, 10249.99):
            $('#sss_contribution').val(400.00);
              break;
            case checkRange(x, 10250, 10749.99):
            $('#sss_contribution').val(420.00);
              break;
            case checkRange(x, 10750, 11249.99):
            $('#sss_contribution').val(440.00);
              break;
            case checkRange(x, 11250, 11749.99):
            $('#sss_contribution').val(460.00);
              break;
            case checkRange(x, 11750, 12249.99):
            $('#sss_contribution').val(480.00);
              break;
            case checkRange(x, 12250, 12749.99):
            $('#sss_contribution').val(500.00);
              break;
            case checkRange(x, 12750, 13249.99):
            $('#sss_contribution').val(520.00);
              break;
            case checkRange(x, 13250, 13749.99):
            $('#sss_contribution').val(540.00);
              break;
            case checkRange(x, 13750, 14249.99):
            $('#sss_contribution').val(560.00);
              break;
            case checkRange(x, 14250, 14749.99):
            $('#sss_contribution').val(580.00);
              break;
            case checkRange(x, 14750, 15249.99):
            $('#sss_contribution').val(600.00);
              break;
            case checkRange(x, 15250, 15749.99):
            $('#sss_contribution').val(620.00);
              break;
            case checkRange(x, 15750, 16249.99):
            $('#sss_contribution').val(640.00);
              break;
            case checkRange(x, 16250, 16749.99):
            $('#sss_contribution').val(660.00);
              break;
            case checkRange(x, 16750, 17249.99):
            $('#sss_contribution').val(680.00);
              break;
            case checkRange(x, 17250, 17749.99):
            $('#sss_contribution').val(700.00);
              break;
            case checkRange(x, 17750, 18249.99):
            $('#sss_contribution').val(720.00);
              break;
            case checkRange(x, 18250, 18749.99):
            $('#sss_contribution').val(740.00);
              break;
            case checkRange(x, 18750, 19249.99):
            $('#sss_contribution').val(760.00);
              break;
            case checkRange(x, 19250, 19749.99):
            $('#sss_contribution').val(780.00);
              break;
            case checkRange(x, 19750, 10000000000000):
              $('#sss_contribution').val(800.00);
              break;
