  ...
  <div class="row mb-2">
    ...
    <div class="col-sm-6">
      <ol class="breadcrumb float-sm-right">
       <li class="breadcrumb-item"><a href="{{ route('admin.payroll.generate') }}">Payroll</a></li>
...
@section('content')
    ...
    <div class="card bg-light mt-3">
        <div class="card-header">
           Create Individual Payroll
        </div>
        <div class="card-body">
           <form action="{{ route('admin.generate.payroll.create') }}" method="POST" enctype="multipart/form-data">
                @csrf
